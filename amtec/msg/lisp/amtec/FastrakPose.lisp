...
;//! \htmlinclude FastrakPose.msg.html

(defclass <FastrakPose> (ros-message)
  ((header
    :reader header-val
    :initarg :header
...
(defmethod serialize ((msg <FastrakPose>) ostream)
  "Serializes a message object of type '<FastrakPose>"
...
(defmethod deserialize ((msg <FastrakPose>) istream)
  "Deserializes a message object of type '<FastrakPose>"
...
(defmethod ros-datatype ((msg (eql '<FastrakPose>)))
  "Returns string type for a message object of type '<FastrakPose>"
  "amtec/FastrakPose")
(defmethod md5sum ((type (eql '<FastrakPose>)))
  "Returns md5sum for a message object of type '<FastrakPose>"
  "6ca806a9c2380f670da316009aa5faaa")
(defmethod message-definition ((type (eql '<FastrakPose>)))
  "Returns full string definition for message of type '<FastrakPose>"
...
(defmethod serialization-length ((msg <FastrakPose>))
  (+ 0
...
(defmethod ros-message-to-list ((msg <FastrakPose>))
