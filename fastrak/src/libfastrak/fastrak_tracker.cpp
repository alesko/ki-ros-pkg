...
//=============================================================================
int tracker::get_origin(double* x, double* y, double* z, double* px_x, double* px_y, double* px_z, double* py_x, double* py_y, double* py_z)
{
  if (get_logging())
    return -1;
...
//=============================================================================
void tracker::setup_boresight(int op)
{
  if (get_logging())
    return;
...
//=============================================================================
int
tracker::recive_stream(double* x, double* y, double* z, double* yaw, double* pitch, double* roll)
{
  //Returns current pose
  char buf[MAX_LENGTH];
  char item[8];
