...
//tracker.hpp
//=============================================================================
#ifndef fastrak_tracker_h_DEFINED
#define fastrak_tracker_h_DEFINED
//=============================================================================
...
class tracker
{
  public:
    ...
    //Creates and opens comport with defaults except number, sets default values for
    //spacing, units, and hemisphere
    tracker(int num);
    ...
    int recive_stream(double* x, double* y, double* z, double* pitch, double* yaw, double* roll);
